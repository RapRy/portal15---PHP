<div class="hidden lg:block mt-10">
    <div class="relative inline-block mr-4">
        <div id="categoriesBtn" class="cursor-pointer relative z-50 py-2 px-5 bg-neutralDark rounded-md">
        ...
        <div id="desktopSubCategories" class="absolute top-0 left-0 w-full z-40 overflow-y-hidden bg-neutralDark rounded-md">
